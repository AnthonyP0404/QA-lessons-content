...
namespace QuickTour.Controllers
{
    ...
    public class ForumController : Controller
    {
        ...
        public ForumController(ILogger<ForumController> logger, IForumContext context, ITransient tran, IScoped scoped, ISingleton single, IOptions<FeaturesConfiguration> features, IConfiguration config)
        {
            _logger = logger;
            _context = context;
            _tran = tran;
